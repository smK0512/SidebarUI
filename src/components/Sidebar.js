...
function Sidebar() {
  return (
    <div className="sidebar__main">
      ...
      <h3 style={{ margin: "9% 0 5% 0", color: "white" }}>IRTI robotics</h3>
      ...
      <div className="sidebar__menu">
        ...
        <SidebarTab
          tabName="PLC Inputs"
          link="/plc_input"
          icon={<AiOutlineArrowRight size="20px"></AiOutlineArrowRight>}
        ></SidebarTab>
        <SidebarTab
          tabName="PLC Output"
          link="/plc_output"
          icon={<AiOutlineArrowLeft size="20px"></AiOutlineArrowLeft>}
        ></SidebarTab>
        <SidebarTab
          tabName="Alarm"
          link="/Notification"
          icon={<BiAlarmExclamation size="20px"></BiAlarmExclamation>}
        ></SidebarTab>
        <SidebarTab
          tabName="Production count"
          link="/prod_count"
          icon={<TbShoppingCartDiscount size="20px"></TbShoppingCartDiscount>}
        ></SidebarTab>
        <SidebarTab
      ...
      <h5 style={{ margin: "30% 0 0 0" }}>Developed by IRTI Robotics</h5>
      <a href="http://www.irti-robotics.com/"> 
      <FaGithub
              size="28px"
              style={{ alignSelf: "center", marginTop: "5%", color: "white" }}
      ></FaGithub>
      </a>
    </div>
  );
